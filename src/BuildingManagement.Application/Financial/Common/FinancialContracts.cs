...
public sealed record AccountAdjustmentRequest(string FinancialAccountOwnerCode, string AccountKindKey, string AdjustmentTypeKey, decimal Amount, DateTimeOffset EffectiveDate, string Reason);
...
public sealed record ExpenseRequest(string? BuildingCode, string? ComplexCode, string ExpenseTypeKey,
...
public sealed record ExpenseTypeResponse(string? Key, string Title, string? BuildingCode,
...
public sealed record ExpenseDisbursementRequest(string FundOwnerCode, string FundAccountKindKey, string? PayeePartyCode, decimal Amount, string PaymentMethodKey, string? Notes);
...
public sealed record DemandRequest(string FundOwnerCode, string FundAccountKindKey, string DemandTypeKey,
...
public sealed record PaymentAllocationRequest(string DemandCode, decimal Amount);
public sealed record PaymentRequest(string UnitCode, string FundOwnerCode, string FundAccountKindKey, string? PayerPartyCode, string PaymentMethodKey, decimal Amount, string? GatewayReference, string? BankTrackingCode, string? Notes, IReadOnlyList<PaymentAllocationRequest> Allocations);
...
public sealed record ReceivableResponse(string DemandCode, string UnitCode, decimal OriginalAmount,
