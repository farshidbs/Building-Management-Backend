...
internal static class FinancialEndpoints
{
    internal static void MapFinancialEndpoints(this RouteGroupBuilder api)
    {
        ...
        expenses.MapPut("/{expenseCode}", (string expenseCode, UpdateExpenseDraftRequest request, ExpenseService service, CancellationToken ct) => service.Update(expenseCode, request, ct));
        ...
        expenses.MapGet("/{expenseCode}/disbursements/{disbursementCode}/files", (string expenseCode, string disbursementCode, FinancialFileService service, CancellationToken ct) => service.DisbursementFiles(expenseCode, disbursementCode, ct));
        ...
        api.MapGet("/financial/units/{unitCode}/payments", (string unitCode, [AsParameters] PageQuery query, PaymentService service, CancellationToken ct) => service.History(unitCode, query, ct)).WithTags("Financial Payments");
